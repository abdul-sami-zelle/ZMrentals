...
//     } else if (e.key === "Enter") {
//       const selectedItem = filteredCountries[activeIndex];
//       if (selectedItem) {
...
//   useEffect(() => {
//     console.log("state check", showCountryCodeList);
//   }, [showCountryCodeList]);
...
//       }
//     }
//   }, [activeIndex, showCountryCodeList]);
...
//           tabIndex={0}
//           style={{ flex: 1 }}
//           onFocus={openDropdown} // open dropdown on focus
//           onKeyDown={handleKeyDown} // allow arrow keys while input is focused
//         />
//       </div>
//       {showCountryCodeList && (
//         <div className="country-code-list show-country-code-list">
...
//               //     tabIndex={-1}
//               //     className={`country-code-inner-item ${index === activeIndex ? "active-code" : ""}`}
//               //     onClick={() => {handleSelectCountry(item); setActiveIndex(index)}}
//               //     // onMouseEnter={() => setActiveIndex(index)}
//               // >
//               //     <p>{item.country}</p>
//               //     <p className="country-code-list-item">
