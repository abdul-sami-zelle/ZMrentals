    ...
    <div className='feedback-gallery-main-container'>
        ...
        <div className='feedback-gallery-description-container'>
              ...
              <p>
                  ...
                  Tick rental car off your list of things to do when you book with GO - we’ve got you covered every step of the way.
              </p>
              <SecondaryButton
        ...
        <div className='feedback-gallery-customer-comment-card-main-container'>
              <div className='feedback-gallery-customer-comment-card-inner-container'>
                  <p>
                      GO Rentals are AWESOME! The car was fantastic, safe and didn’t miss a beat. From the moment we picked up the car
                      the staff were so helpful and gave us lots of local knowledge tips. 10/10 thanks Go rentals!
                  </p>
