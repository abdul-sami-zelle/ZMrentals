    ...
    <div className="about-us-page-main-container">
      ...
      <div className="about-us-inner-section">
        <div className="about-us-max-width-container">
          ...
          <ServiceDetail
            serviceImage={`/assets/about-us/Sustainable-Responsibility.jpg`}
          ...
          <ServiceDetail
            serviceImage={`/assets/about-us/Professsionalism.jpg`}
          ...
          <ServiceDetail
            serviceImage={`/assets/about-us/Tech-Driven-Information.jpg`}
          ...
          <ServiceDetail
            serviceImage={`/assets/about-us/Reliability-&-Integrity.jpg`}
